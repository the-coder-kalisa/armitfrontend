...
export async function postValidateCode(code) {
 ...
 */
export async function postValidatePrompt(name, template, frontend_node) {
...
export async function getExamples() {
  ...
  const contentsPromises = jsonFiles.map(async file => {
 ...
 */
export async function updateFlowInDatabase(updatedFlow) {
  try {
 ...
 */
export async function deleteFlowFromDatabase(flowId) {
  try {
 ...
 */
export async function getFlowFromDatabase(flowId) {
  try {
 ...
 * @throws Will throw an error if saving fails.
 */
export async function saveFlowStyleToDatabase(flowStyle) {
  try {
 ...
 *
 */
export async function getBuildStatus(flowId) {
 ...
 *
 */
export async function postBuildInit(flow) {
...
export async function postCustomComponent(code, apiClass) {
