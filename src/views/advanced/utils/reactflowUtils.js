...
export function cleanEdges({ flow: { edges, nodes }, updateEdge }) {
...
export function removeApiKeys(flow) {
...
export function updateTemplate(reference, objectToUpdate) {
  let clonedObject = _.cloneDeep(reference)
...
export function validateNode(node, reactFlowInstance) {
...
export function validateNodes(reactFlowInstance) {
  ...
  return reactFlowInstance
    .getNodes()
    .flatMap(n => validateNode(n, reactFlowInstance))
}
...
export function getConnectedNodes(edge, nodes) {
